                                ...
                                <div class="flex p-3 text-white space-x-4">
                                    ...
                                    <span class="ml-2 space-x-1 ">
                                        @foreach ($movie->genres as $genre)
                                            <a class="font-bold text-gray-100 hover:text-white bg-gradient-to-r from-indigo-700 to-transparent hover:bg-indigo-700 hover:shadow-lg rounded px-1 py-1 shadow-md"
